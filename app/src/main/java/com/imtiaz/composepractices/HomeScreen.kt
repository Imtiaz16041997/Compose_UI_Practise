...
/*meditation section*/
@Composable
fun CurrentMeditation(color: Color = Color.Yellow) {
...
/*FeaturedSection*/
@Composable fun FeatureSection(features : List<Feature>) {
...
fun FeatureItem(feature: Feature) {
    ...
    BoxWithConstraints(modifier = Modifier
        ...
        // Medium Colored path
        val mediumColoredPoint1 = Offset(0.2f, height * 0.3f)
        ...
        val lightColoredPath = Path().apply{moveTo(lightPoint1.x, lightPoint2.y)
